...
from RandLANet_S3DIS_Mstep import Network
...
class S3DIS:
    def __init__(self, test_area_idx, pseudo_label_path):
        self.name = 'S3DIS'

        # Dataset path
        self.path = '../Datasets/Datesets/S3DIS'

        self.pseudo_label_path = pseudo_label_path

        #Save path of label points and their corresponding labels
        self.gt1_path = './S3DIS_gt'
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            if self.val_split in cloud_name:
                ...
                gt_label_file = join(self.gt1_path, cloud_name + '.npy')
    ...
    def get_batch_gen(self, split):
        ...
        def spatially_regular_gen():
            ...
            for i in range(num_per_epoch):
                ...
                queried_pc_labels_gt = self.input_labels_gt[split][cloud_idx][queried_idx]
                ...
                if len(points) < cfg.num_points:
                    queried_pc_xyz, queried_pc_colors, queried_idx, queried_pc_label = \
                        DP.data_aug(queried_pc_xyz, queried_pc_colors, queried_pc_label, queried_idx, cfg.num_points)
    ...
    def get_tf_mapping2():
        # Collect flat inputs
        def tf_map(batch_xyz, batch_features, batch_labels, batch_labels_gt, batch_pc_idx, batch_cloud_idx):
            ...
            input_list += [batch_features, batch_labels, batch_labels_gt, batch_pc_idx, batch_cloud_idx]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='RandLANet_S3DIS_Mstep.py', help='')
    parser.add_argument('--log_dir', type=str, default= 'ex', help='')
    parser.add_argument('--load_dir', type=str, default= '1pt-iteration1', help='')
    parser.add_argument('--knn', type=int, default=16, help='k_nn')
    parser.add_argument('--pseudo_label_path', type=str, default='./experiment/S3DIS/1_points_/1pt-pre_train/prediction/pseudo_label', help='pseudo label path')
    ...
    dataset = S3DIS(test_area, FLAGS.pseudo_label_path)

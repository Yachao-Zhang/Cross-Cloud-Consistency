...
from RandLANet_S3DIS_pretrain import Network
from prediction_S3DIS import ModelTester
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='RandLANet_S3DIS_pretrain.py', help='')
    parser.add_argument('--log_dir', type=str, default='1pt-pre', help='')
    ...
    dataset.pseudo_label_dir = FLAGS.pseudo_label_dir
